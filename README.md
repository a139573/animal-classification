...
```bash
uvx --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ --from "animal-classification-aldanondo-malon==1.3.2" animal-dashboard
```
...
```bash
uv add --default-index https://test.pypi.org/simple/ --index https://pypi.org/simple/ "animal-classification-aldanondo-malon==1.3.2"
```
...
```bash
uv pip install animal-classification-aldanondo-malon-1.3.2.whl
```
